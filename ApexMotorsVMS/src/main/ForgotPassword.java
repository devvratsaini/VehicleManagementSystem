...
public class ForgotPassword extends javax.swing.JFrame {
    ...
    private void initImages() {
        ...
        ImageIcon logoIcon = new ImageIcon(getClass().getResource("/resources/bg_images/ForgotPassword1.png"));
        Image logoImage = logoIcon.getImage();
        Image logoScaledimage = logoImage.getScaledInstance(forgotPasswordLogo1.getWidth(), forgotPasswordLogo1.getHeight(), Image.SCALE_SMOOTH);
        ImageIcon logoScaledIcon = new ImageIcon(logoScaledimage);
        forgotPasswordLogo1.setIcon(logoScaledIcon);
            ...
            try {
                ...
                try (PreparedStatement pstmt = conn.prepareStatement(query)) {
                    ...
                    if (rs.next()) {
                        ...
                        JOptionPane.showMessageDialog(rootPane, "Invalid username and/or email!", "Input Error", JOptionPane.ERROR_MESSAGE);
                    }
                    
                } catch (SQLException ex) {
                    JOptionPane.showMessageDialog(rootPane, "SQL Error: " + ex.getMessage(), "Database Error", JOptionPane.ERROR_MESSAGE);
                }
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        ...
        // verifying password is not empty
                ...
                try {
                    ...
                    if (newPass.equals(confPass)) {
                        ...
                        try (PreparedStatement pstmt = conn.prepareStatement(query)) {
                            ...
                            pstmt.setString(2, foundUsername);
                        ...
                        JOptionPane.showMessageDialog(rootPane, "Passwords do not match!", "Input Error", JOptionPane.ERROR_MESSAGE);
                    }
